...
const AdminActivities = (props) =>{
    ...
    return (
       <View  style={{flex:1}}>
            ...
            { myHospital ?
                <TouchableOpacity underlayColor='#fff' style={adminActivityListStyle.syncButton}
            ...
            {this.getAvatar(avatarUrl,navigation)}
               ...
               { myHospital ?
               <TouchableOpacity underlayColor='#fff' style={adminActivityListStyle.plusButton}
